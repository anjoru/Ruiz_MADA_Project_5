...
# Fit a null logistic regression model to compare the model with temperature and precipitation variables to a simpler model with no predictors.
null_logistic_model <- glm(Positive_Result ~ 1, family = binomial, data = combined_wx_pcr)
summary(null_logistic_model)
